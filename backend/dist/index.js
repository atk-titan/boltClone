...
const { templateFetcher, solFetcher } = require('./AI/tempFetcher');
const openai = require('./AI/config');
const app = express();
...
app.post("/chat", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const answer = yield solFetcher(messages);
        console.log("answer:" + answer);
        res.status(200).json({ answer: answer });
    }
    catch (err) {
        console.log(err);
        return res.status(500).json({ msg: 'something worng while getting response from LLM in CHAT endpoint.', err: err });
    }
}));
app.listen(3000, () => {
...
//   const sysPrompt:string = getSystemPrompt();
...
//   // console.log(res);
// }
// main("create a simple to do app");
